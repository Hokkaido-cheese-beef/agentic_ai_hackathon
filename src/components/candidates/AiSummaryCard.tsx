...
export function AiSummaryCard({ aiSummary }: AiSummaryCardProps) {
  return (
    <div className="flex flex-col gap-2.5 rounded-2xl bg-[#FFFBEB] p-3.5 border border-[#FDE68A]">
      ...
      <div className="flex flex-col gap-2">
        {aiSummary.qa.map((item, i) => (
          <div key={i} className="flex flex-col gap-1 rounded-[10px] bg-[#FEF3C7] p-2.5">
